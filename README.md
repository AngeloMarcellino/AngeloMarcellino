...
- Buscando atuar como `Desenvolvedor Junior / Desenvolvedor`
- Atualmente aprofudando meus conhecimentos na linguagem `C e Inglês`
...
- [x] Iniciar um projeto
- [x] Criar um README de perfil
- [x] Começar a estudar inglês
- [ ] Subir 1 projeto completo no GitHub
- [ ] Melhorar o meu nível de Inglês para leiturar e técnica
...
## Como falar comigo
- [Linkedin](https://www.linkedin.com/in/angelo-marcelino-774905234/)
- `angelo_gabriel1998@hotmail.com`
